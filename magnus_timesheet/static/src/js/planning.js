...
var WeeklyPlanning = form_common.FormWidget.extend(form_common.ReinitializeWidgetMixin, {
    ...
    initialize_content: function() {
        ...
        return this.render_drop.add(new Model("account.analytic.line").call("default_get", [
            ['account_id','general_account_id','journal_id','date','name','user_id','product_id','product_uom_id','amount','unit_amount','project_id', 'select_week_id', 'planned'],
    ...
    init_add_project: function() {
        ...
        var self = this;
        this.$(".oe_planning_weekly_add_row").show();
        ...
        this.project_m2o.prependTo(this.$(".o_add_planning_line > div")).then(function() {

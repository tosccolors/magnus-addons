...
class HrTimesheetSheet(models.Model):
    ...
    def _get_validator_user_ids(self):
        ...
        for timesheet in self:
            managers_to_add = []
            comanagers_ids_dept = [manager.id for manager in timesheet.department_id.manager_2_ids]
            comanagers_ids_parent_dept = [manager.id for manager in timesheet.department_id.parent_id.manager_2_ids]
